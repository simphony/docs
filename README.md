...
- [Getting started](#getting-started)
  ...
  - [Installation](#installation)
    - [OSP-core installation](#osp-core-installation)
...
_Contact:_ [Pablo de Andres](mailto:pablo.de.andres@iwm.fraunhofer.de), [Matthias Urban](mailto:matthias.urban@iwm.fraunhofer.de) and [Yoav Nahshon](mailto:yoav.nahshon@iwm.fraunhofer.de) from the Material Informatics team, Fraunhofer IWM.

_Version:_ 1.0 pending approval
## Terminology
...
<details>
  ...
  ![interoperability schema](img/interoperability.png)
...
<details>
  ...
  ![3 layer schema](img/three_layers.png)
...
Said ontology must be in a YAML format as defined by [our specification](https://gitlab.cc-asp.fraunhofer.de/simphony/osp-core/blob/master/doc/yaml_spec.md).
...
Tools for converting EMMO from the OWL format to YAML are provided. See more [here](https://gitlab.cc-asp.fraunhofer.de/simphony/osp-core/blob/master/doc/working_with_emmo.md).
...
<details>
  ...
  ![sessions hierarchy](img/sessions.png)
